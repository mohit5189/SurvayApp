...
VIEW_FILE_PATH="\${SRCROOT}/SurvayApp/Modules/${MODULE_NAME}/${MODULE_NAME}View.swift"
INTERACTOR_FILE_PATH="\${SRCROOT}/SurvayApp/Modules/${MODULE_NAME}/${MODULE_NAME}Interactor.swift"
...
# Sort project file
python Scripts/xUnique.py -scpv "SurvayApp.xcodeproj/project.pbxproj"
